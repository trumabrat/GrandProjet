...
extern void SVGinit(SVGwriter *svg,char *nomfic, int sizeX, int sizeY);

/* Fixe la couleur des lignes pour la suite */
extern void SVGlineColor(SVGwriter *svg, char *col);

/* Fixe une couleur aleatoire pour les lignes pour la suite */
extern void SVGlineRandColor(SVGwriter *svg);

/* Fixe la couleur des points pour la suite */
extern void SVGpointColor(SVGwriter *svg, char *col);

/* Ecrit un point dans le fichier */ 
extern void SVGpoint(SVGwriter *svg, double x, double y);

/*Ecrit un segment dans le fichier */
extern void SVGline(SVGwriter *svg, double xa, double ya, double xb, double yb);

/* Ferme le fichier */
extern void SVGfinalize(SVGwriter *svg);
